...
def reshape_to_clusters(input_file, output_file, sep=",", gene_col="gene_symbol", cluster_col="cluster", 
                        gene_sep=";", additional_cols=None):
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Reshape gene-level data to cluster-level data.')
    parser.add_argument('--input', required=True, help='Input file path')
    parser.add_argument('--output', required=True, help='Output file path')
    parser.add_argument('--sep', default=",", help='Input file separator (default: comma)')
    parser.add_argument('--gene_col', default="gene_symbol", help='Column name for gene identifiers')
    parser.add_argument('--cluster_col', default="cluster", help='Column name for cluster assignments')
    parser.add_argument('--gene_sep', default=";", help='Separator for genes in output file')
    parser.add_argument('--additional_cols', default=None, help='Comma-separated list of additional columns to include')
